...
function Game() {
    ...
    document.addEventListener("keydown", function(e) {
        ...
        document.addEventListener("keyup", function(e) {
            ...
            this.highScores = []; // Array for high scores
}
...
Game.prototype.updateHighScores = function(score) {
    this.highScores.push(score);
    this.highScores.sort(function(a, b) { return b - a; }); // Sort high scores in descending order
    if (this.highScores.length > 5) { // Keep only the top 5 scores
        this.highScores = this.highScores.slice(0, 5);
    }
    this.displayHighScores(); // Update the display after updating scores
};
...
Game.prototype.displayHighScores = function() {
    ...
    if (this.highScores.length > 0) {
        for (let i = 0; i < this.highScores.length; i++) {
            ...
            scoreItem.textContent = (i + 1) + ". " + this.highScores[i];
            highScoreList.appendChild(scoreItem);
        }
    } else {
        highScoreList.textContent = "Play the game to find out how good you are!";
    }
};
...
Game.prototype.draw = function() {
    ...
    this.context.shadowStyle = "black"; // Add shadow color for text
